  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        {name: 'value', title: 'Value for Money', type: 'number', validation: Rule => Rule.min(1).max(10)},
        {name: 'support', title: 'Customer Support', type: 'number', validation: Rule => Rule.min(1).max(10)},
        {name: 'security', title: 'Security', type: 'number', validation: Rule => Rule.min(1).max(10)},
